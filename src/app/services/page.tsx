                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {services.map((s, i) => (
                            <Reveal key={i} delay={i * 0.1}>
                                <div className="flex gap-6 p-8 border border-gray-100 rounded-2xl hover:shadow-lg transition-shadow bg-gray-50 hover:bg-white group">
                                    <div className="w-16 h-16 shrink-0 bg-red-100 text-primary rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                                        <s.icon size={32} />
                                    </div>
                                    <div>
                                        <h3 className="text-2xl font-bold font-heading text-secondary mb-3">{s.title}</h3>
